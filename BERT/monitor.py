...
class monitor:
    ...
    def __init__(self,sut,prefix,config,output_path,interval=0.2,sample_count=100, onefileconcat = False, show_plot=False):
        ...
        if prefix[:5] == "SQuAD":
            if sut[-8:] == "TRAIN.py":
                print("Running TRAIN")
                p = psutil.Popen([sys.executable, sut,"--vocab_file=C:/Dev/bert-master/bert_model/vocab.txt","--bert_config_file=C:/Dev/bert-master/bert_model/bert_config.json","--init_checkpoint=C:/Dev/bert-master/bert_model/bert_model.ckpt","--do_train=true","--train_file=C:/Dev/bert-master/squad_dir/train-v1.1.json","--do_predict=True","--predict_file=C:/Dev/bert-master/squad_dir/dev-v1.1.json","--train_batch_size=12","--learning_rate=3e-5","--num_train_epochs=2.0","--max_seq_length=384","--doc_stride=128","--output_dir=/tmp/squad_base/"])    
            elif sut[-8:] == "MODEL.py":
                print("Running MODEL")
                p = psutil.Popen([sys.executable, sut,"--vocab_file=C:/Dev/bert-master/bert_model/vocab.txt","--bert_config_file=C:/Dev/bert-master/bert_model/bert_config.json","--init_checkpoint=C:/Dev/bert-master/bert_model/bert_model.ckpt","--do_train=true","--train_file=C:/Dev/bert-master/squad_dir/train-v1.1.json","--do_predict=True","--predict_file=C:/Dev/bert-master/squad_dir/dev-v1.1.json","--train_batch_size=24","--learning_rate=5e-5","--num_train_epochs=2.0","--max_seq_length=384","--doc_stride=128","--output_dir=/tmp/squad_base/"])    
            else:
                p = psutil.Popen([sys.executable, sut,"--vocab_file=C:/Dev/bert-master/bert_model/vocab.txt","--bert_config_file=C:/Dev/bert-master/bert_model/bert_config.json","--init_checkpoint=C:/Dev/bert-master/bert_model/bert_model.ckpt","--do_train=true",config[0],"--do_predict=True",config[1],"--train_batch_size=12","--learning_rate=3e-5","--num_train_epochs=2.0","--max_seq_length=384","--doc_stride=128","--output_dir=/tmp/squad_base/"])    
        else:
            p = psutil.Popen([sys.executable, sut,config[0],"--do_train=true","--do_eval=true",config[1],"--vocab_file=C:/Dev/bert-master/bert_model/vocab.txt","--bert_config_file=C:/Dev/bert-master/bert_model/bert_config.json","--init_checkpoint=C:/Dev/bert-master/bert_model/bert_model.ckpt","--max_seq_length=128","--train_batch_size=8","--learning_rate=2e-5","--num_train_epochs=3.0","--output_dir=C:/tmp/mrpc_output"])
        
        #p = psutil.Popen([sys.executable, sut,"--task_name=MRPC","--do_train=true","--do_eval=true","--data_dir=C:/Dev/bert-master/glue_data/MRPC","--vocab_file=C:/Dev/bert-master/bert_model/vocab.txt","--bert_config_file=C:/Dev/bert-master/bert_model/bert_config.json","--init_checkpoint=C:/Dev/bert-master/bert_model/bert_model.ckpt","--max_seq_length=128","--train_batch_size=8","--learning_rate=2e-5","--num_train_epochs=3.0","--output_dir=C:/tmp/mrpc_output"])
