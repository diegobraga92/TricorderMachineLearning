...
# EXPERIMENT CONFIGURATION - PRECISA MODIFICAR #
interval = 0.1 
samples = 60
executionsTrain = 50
executionsTest = 30
input_type = 'Decision_Tree' # CRIAR MANUALMENTE
...
# PRECISA MODIFICAR - COLOCAR NOME DA APLICACAO #
...
# PRECISA MODIFICAR - USADO PARA PASSAR COMO ARGUMENTO #
configs = {
...
for sut_server in exefiles:
	...
	print ('SUTs: ' + sut_server)
        ...
        # PRECISA MODIFICAR - COLOCAR NOME DA APLICACAO SEM ERROS #
        # MUDAR TAMBEM O -22 para o tamanho do nome do arquivo #
