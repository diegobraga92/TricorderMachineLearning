...
class ResourceConfig:
    ...
    def __init__(self):
        ...
        self.model_best_config_path = os.path.join(self.model_dir, "model_best_config_TRAIN.json")
        self.model_best_weight_path = os.path.join(self.model_dir, "model_best_weight_TRAIN.h5")
